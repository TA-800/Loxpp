...
int main(int argc, char *argv[])
{
    ...
    // -> ( * ( - 123 ) 45.67 )
    /* std::unique_ptr<Expr> binary = std::make_unique<Binary>( std::make_unique<Unary>(Token(TokenInfo::MINUS, "-",
     * nullptr, 1), std::make_unique<Literal>((void *)new double(123), TokenInfo::Type::NUMBER)), Token(TokenInfo::STAR,
     * "*", nullptr, 1), std::make_unique<Literal>((void *)new double(45.67), TokenInfo::Type::NUMBER)); */
